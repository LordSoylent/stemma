...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("STEMMA Core stemma-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  stemma-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded stemma transaction") + "\n" +
                               "  stemma-tx [options] -create [commands]   " + _("Create hex-encoded stemma transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded stemma transaction
