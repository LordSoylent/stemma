...
/** Utility functions used by the STEMMA Qt UI.
 */
namespace GUIUtil
{
...
// Render STEMMA addresses in monospace font
...
// Parse "stemma:" URI into recipient object, return true on successful parsing
