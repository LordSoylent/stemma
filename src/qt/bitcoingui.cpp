                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("STEMMA-Coin") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a STEMMA address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and stemma: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About STEMMA Core"), this);
    aboutAction->setStatusTip(tr("Show information about STEMMA Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for STEMMA"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your STEMMA addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified STEMMA addresses"));
    ...
    openAction->setStatusTip(tr("Open a STEMMA: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the STEMMA Core help message to get a list with possible STEMMA command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("STEMMA Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to STEMMA network", "", count));
}
...
{
    QString strTitle = tr("STEMMA Core"); // default title
