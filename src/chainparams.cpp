...
{
    const char* pszTimestamp = "stemma.team future coin";
...
static Checkpoints::MapCheckpoints mapCheckpoints =
    boost::assign::map_list_of
		(0, uint256("0x00000279ce7b8d9d06bd6e4c7d17aee7e24ad2a9f0e3c32606bf3c75b5582d14"))
		;
...
public:
    CMainParams()
    {
        ...
        genesis = CreateGenesisBlock(1537273296, 20783435, 0x1e0ffff0, 1, 0 * COIN);

        hashGenesisBlock = genesis.GetHash();

        assert(hashGenesisBlock == uint256("0x00000279ce7b8d9d06bd6e4c7d17aee7e24ad2a9f0e3c32606bf3c75b5582d14"));
        assert(genesis.hashMerkleRoot == uint256("0x2ec6706e106371802408c689b5911fcea46e77b4777854d68ddb6e213523b850"));
		
	vSeeds.push_back(CDNSSeedData("seed1.stemma.team", "seed1.stemma.team"));
	vSeeds.push_back(CDNSSeedData("seed2.stemma.team", "seed2.stemma.team"));
	vSeeds.push_back(CDNSSeedData("seed3.stemma.team", "seed3.stemma.team"));
	...
	nStartMasternodePayments = 1537273296; 
