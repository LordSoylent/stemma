...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* STEMMA features */
        {"stemma", "masternode", &masternode, true, true, false},
        {"stemma", "masternodelist", &masternodelist, true, true, false},
        {"stemma", "mnbudget", &mnbudget, true, true, false},
        {"stemma", "mnbudgetvoteraw", &mnbudgetvoteraw, true, true, false},
        {"stemma", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"stemma", "mnsync", &mnsync, true, true, false},
        {"stemma", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use stemmad, or the -server option to stemma-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> stemma-cli " + methodname + " " + args + "\n";
}
