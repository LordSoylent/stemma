...
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='stemma.conf'
CONFIGFOLDER='/root/.stemma'
COIN_DAEMON='stemmad'
COIN_CLI='stemma-cli'
COIN_PATH='/usr/local/bin/'
COIN_REPO='https://github.com/StemmaOfficial/stemma.git'
COIN_TGZ='https://github.com/StemmaOfficial/stemma/releases/download/v2.0/STEMMA-linux.tar.gz'
