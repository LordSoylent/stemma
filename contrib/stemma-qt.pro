...
RESOURCES += src/qt/stemma.qrc src/qt/stemma_locale.qrc

TRANSLATIONS += src/qt/locale/stemma_bg.ts \
                src/qt/locale/stemma_de.ts \
                src/qt/locale/stemma_en.ts \
                src/qt/locale/stemma_es.ts \
                src/qt/locale/stemma_fi.ts \
                src/qt/locale/stemma_fr.ts \
                src/qt/locale/stemma_it.ts \
                src/qt/locale/stemma_ja.ts \
                src/qt/locale/stemma_pl.ts \
                src/qt/locale/stemma_pt.ts \
                src/qt/locale/stemma_ru.ts \
                src/qt/locale/stemma_sk.ts \
                src/qt/locale/stemma_sv.ts \
                src/qt/locale/stemma_vi.ts \
                src/qt/locale/stemma_zh_CN.ts \
                src/qt/locale/stemma_zh_TW.ts
